...
`
	...
	tokens := []Token{
		...
		nl,
		{Literal: "bool1", Type: TokBasic},
		{Type: TokEqual},
		{Literal: "true", Type: TokBool},
		nl,
		{Literal: "bool2", Type: TokBasic},
		{Type: TokEqual},
		...
		{Type: TokEqual},
		{Literal: "basic string", Type: TokBasic},
		nl,
		{Literal: "literal", Type: TokIdent},
		{Type: TokEqual},
		{Literal: "literal string", Type: TokLiteral},
		nl,
		{Literal: "multiline1", Type: TokIdent},
		{Type: TokEqual},
		{Literal: "The quick brown fox jumps over the lazy dog.", Type: TokBasicMulti},
		nl,
		{Literal: "multiline2", Type: TokIdent},
		{Type: TokEqual},
		{Literal: "Roses are red\nViolets are blue", Type: TokBasicMulti},
		nl,
		{Literal: "quote", Type: TokIdent},
		{Type: TokDot},
		{Literal: "single", Type: TokIdent},
		{Type: TokEqual},
		{Literal: "quote can be 'quoted'!", Type: TokLiteralMulti},
		nl,
		{Literal: "quote", Type: TokIdent},
		{Type: TokDot},
		{Literal: "double", Type: TokIdent},
		{Type: TokEqual},
		{Literal: "quote can be \"\"quoted\"\"!", Type: TokBasicMulti},
		nl,
		{Literal: "unicode1", Type: TokIdent},
		{Type: TokEqual},
		{Literal: "a heart \u2665!", Type: TokBasic},
		nl,
		{Literal: "unicode2", Type: TokIdent},
		{Type: TokEqual},
		{Literal: "not a heart \\u2665!", Type: TokBasic},
		nl,
		{Type: TokBegRegularTable},
		...
		{Type: TokEqual},
		{Type: TokBegArray},
		{Literal: "basic", Type: TokBasic},
		{Type: TokComma},
		{Literal: "literal", Type: TokLiteral},
		{Type: TokEndArray},
		nl,
		...
		{Type: TokComma},
		{Type: TokBegArray},
		{Literal: "foo", Type: TokBasic},
		{Type: TokComma},
		{Literal: "bar", Type: TokBasic},
		{Type: TokComma},
		{Type: TokEndArray},
		{Type: TokComma},
		{Type: TokBegInline},
		...
		{Type: TokEndArray},
		{Type: TokComma},
		{Literal: "roles", Type: TokBasic},
		{Type: TokEqual},
		{Type: TokBegArray},
		{Literal: "user", Type: TokBasic},
		{Type: TokComma},
		{Literal: "admin", Type: TokBasic},
		{Type: TokComma},
		{Literal: "guest", Type: TokBasic},
		{Type: TokComma},
